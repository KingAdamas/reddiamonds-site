...
export default function CreatorHub() {
  ...
  return (
    <div className="min-h-screen bg-[#F7F3EF] text-black font-sans selection:bg-white selection:text-[#8B0000] relative">
      ...
      <main className="max-w-7xl mx-auto px-6 py-32">
        ...
        <section className="mb-24">
          <div className="bg-white border border-zinc-200 rounded-3xl p-10 md:p-20 text-center shadow-2xl relative overflow-hidden">
            ...
            <div className="flex flex-col md:flex-row justify-center items-center gap-5">
              ...
              <button onClick={() => handleGateEntry('youtube-hub')} className="w-full md:w-auto bg-[#8B0000] text-white text-[11px] uppercase tracking-[0.25em] font-black py-6 px-12 rounded-full transition-all hover:bg-[#a00000]">RDI YOUTUBE CREATORS HUB</button>
            </div>
          </div>
        </section>
        ...
        <section id="tiktok-hub" className="mb-24 pt-10">
          <h3 className="text-4xl font-black italic uppercase tracking-tighter border-b-2 border-black/10 pb-6 mb-12 text-center md:text-left text-black">JOIN SYSTEM</h3>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            ...
            <div id="enrollment" className="bg-white border border-zinc-200 p-8 rounded-3xl shadow-xl flex flex-col items-center md:items-start text-center md:text-left">
              ...
              <div className="space-y-4 mb-14 w-full">
                <Link href="/contact" className="block w-full bg-[#8B0000] text-white text-center py-5 rounded-xl font-black uppercase tracking-widest text-[11px] hover:bg-[#a00000] transition-all">CONTACT YOUR RDI MANAGER</Link>
              </div>
              <div className="mt-12 pt-10 border-t border-zinc-100 w-full text-center md:text-left">
                <h4 className="text-[#8B0000] text-sm font-black mb-8 tracking-widest uppercase italic">Downloads</h4>
        ...
        <section className="mb-24 pt-10">
          <h3 className="text-4xl font-black italic uppercase tracking-tighter border-b-2 border-black/10 pb-6 mb-12 text-center md:text-left text-black">GROWTH MATRIX</h3>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              { title: 'Platform Resources', desc: 'Technical guides, setup documentation, and platform-specific tools for TikTok and YouTube.' },
            ].map(({ title, desc }) => (
        ...
        <section id="youtube-hub" className="mb-24 pt-10">
          <h3 className="text-4xl font-black italic uppercase tracking-tighter border-b-2 border-black/10 pb-6 mb-12 text-black text-center md:text-left">STANDARDS</h3>
          <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
            {['Consistency', 'Professionalism', 'Coachability', 'Communication', 'Accountability'].map((standard) => (
              <div key={standard} className="py-8 border border-white/20 rounded-2xl text-center bg-white hover:bg-[#8B0000] hover:text-white transition-all text-black border-zinc-200 shadow-xl">
