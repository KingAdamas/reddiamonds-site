          ...
          {status === "SUBMITTED" ? (
            ...
            <>
              <div className="border-b border-[#1a1a1a] pb-10 text-center">
                <p className="text-sm font-bold uppercase tracking-[0.4em] text-[#ecc970]">Institutional Access</p>
              ...
              <div className="mt-16 grid gap-12 md:grid-cols-2 text-left">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <input required name="Name" type="text" placeholder="NAME" className="w-full bg-black border border-[#1a1a1a] rounded-xl px-5 py-5 text-base focus:border-[#ecc970] outline-none transition-colors" />
                  <input required name="Email" type="email" placeholder="EMAIL ADDRESS" className="w-full bg-black border border-[#1a1a1a] rounded-xl px-5 py-5 text-base focus:border-[#ecc970] outline-none transition-colors" />
                  <textarea required name="Message" placeholder="MESSAGE" rows={4} className="w-full bg-black border border-[#1a1a1a] rounded-xl px-5 py-5 text-base focus:border-[#ecc970] outline-none resize-none transition-colors"></textarea>
